(function ($) {
    ...
    /* Ajustes de tema removidos: se eliminó rs_settings_append y su UI */
    ...
    let rtl_setting = rs_rtl === 'rtl' ? true : false;
     ...
     /* rs_settings_append removed to keep main.js libre de UI inline */
    // rtl setting end
        ...
        if ($('#pie-chart').length) {
            new Chart(document.getElementById("pie-chart") , {
                ...
                data : {
                    ...
                    datasets : [ {
                        backgroundColor : ["#0D80CE","#5CC8BE","#3B37FD","#EE0D08","#00236B"],
                        data : ["16","36","46","56","76"],
                    } ]
                },
                options : {
